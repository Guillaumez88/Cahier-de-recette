...
(function (global) {
  ...
  var REGLES = [
    ...
    // --- Fruits et légumes ---
    [/abricot|pommes?\b|poire|fraise|framboise|banane|citron|orange|ail\b|oignon|echalote|aubergine|courgette|carotte|tomate|poivron|champignon|salade|epinard|persil|basilic|aneth|ciboulette|coriandre|menthe|pomme de terre|patate|brocoli|chou|haricot|petits pois|concombre|radis|betterave|celeri|poireau|navet|fenouil|potiron|courge|blette|bette\b/, 'Fruits et légumes'],
